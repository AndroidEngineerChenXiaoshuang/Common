...
public class PasswordView extends RelativeLayout {
    ...
    private VirtualKeyboardView amountKeyboardView;
    ...
    public PasswordView(Context context, AttributeSet attrs) {
        ...
        amountKeyboardView = view.findViewById(R.id.virtualKeyboardView);
        imgCancel = view.findViewById(R.id.img_cancel);
        gridView = amountKeyboardView.getGridView();
        textAmount = view.findViewById(R.id.textAmount);
        service_rate = view.findViewById(R.id.service_rate);
